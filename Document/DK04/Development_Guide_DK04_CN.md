...
- [开发概述](#开发概述)
	...
	- [Windows运行环境安装](#windows运行环境安装)
			...
			- [4 测试(DeviceTest)](#4-测试devicetest)
- [开发指南](#开发指南)
	- [Unity SDK](#unity-sdk)
...
#### 5 运行测试Demo
设备和手机保持连接状态，运行Device Test，通过界面可观察到从手柄的坐标、姿态、按键等信息，另外，通过点击UI上的'X-Hawk'和'X-Cobra'按钮，观察不同的数据。
...
<div align = center>
<img src="./imgs/install_usb_dongle_2.png" width="400">
</div>
3 选择“Browse my computer for driver software”
<div align = center>
<img src="./imgs/install_usb_dongle_3.png" width="400">
</div>
4 选择“Let me pick from….”，出现窗口
<div align = center>
<img src="./imgs/install_usb_dongle_4.png" width="400">
</div>
